...
fun AppNavigation(
    ...
    NavHost(navController, startDestination = Screen.Home.route, modifier) {
        nowPlayingMovieScreen(onMovieItemClick = navController::navigateToMovieDetailScreen)
        popularMovieScreen(onMovieItemClick = navController::navigateToMovieDetailScreen)
        topRatedMovieScreen(onMovieItemClick = navController::navigateToMovieDetailScreen)
        upcomingMovieScreen(onMovieItemClick = navController::navigateToMovieDetailScreen)
