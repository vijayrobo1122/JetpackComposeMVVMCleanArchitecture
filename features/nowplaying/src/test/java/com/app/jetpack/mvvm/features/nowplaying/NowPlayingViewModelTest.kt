...
class NowPlayingViewModelTest {
    ...
    private val getNowPlayingMoviesUseCase = mockk<GetNowPlayingMoviesUseCase>(relaxed = true)
    ...
    private lateinit var sut: NowPlayingViewModel
    ...
    @Test
    fun `test nowPlayingMovies flow emits empty data correctly`() = runTest {
        // Given
    ...
    @Test
    fun `test nowPlayingMovies flow handles failure`() = runTest {
        // Given
        ...
        // When
        coEvery { getNowPlayingMoviesUseCase.invoke("genreId") } returns errorFlow
    ...
    fun `fetchGenres fetches genres and maps to GenreState with All genre prepended`() {
        ...
        val expectedGenreState = listOf(NowPlayingViewModel.addGenreState) + mockGenres.map {
