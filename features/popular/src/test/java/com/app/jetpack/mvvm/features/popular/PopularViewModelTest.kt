...
class PopularViewModelTest {
    ...
    fun setUp() {
        ...
        sut = PopularViewModel(getPopularMoviesUseCase, movieItemToUiStateMapper)
    }
    ...
    @Test
    fun `test popularMovies flow emits empty data correctly`() = runTest {
        // Given
    ...
    @Test
    fun `test popularMovies flow handles failure`() = runTest {
        // Given
        ...
        // When
        coEvery { getPopularMoviesUseCase.invoke("genreId") } returns errorFlow
